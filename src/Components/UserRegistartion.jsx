...
const navigate = useNavigate(); // Hook for navigation
  ...
  const handleSubmit = async (e) => {
    ...
    Object.keys(formData).forEach((key) => {
        if (key !== "profileImage" && formData[key]) {
            if (key === "payment_details") {
                ...
                formDataObj.append("payment_details", JSON.stringify(formData[key]));
            } else {
    ...
    try {
        const response = await axios.post("http://localhost:5000/user/register", formDataObj, {
              ...
              <div>
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <input
                      type="text"
                      name="name_on_card" value={formData.name_on_card} onChange={handleChange}
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div className="md:col-span-1">
                      ...
                      <div className="relative">
                        ...
                        <input
                          type="text"
                          name="caed_number" value={formData.caed_number} onChange={handleChange}
                    ...
                    <div>
                      ...
                      <div className="relative">
                        ...
                        <input
                          type="text"
                          name="expiry_date" value={formData.expiry_date} onChange={handleChange}
                          className="w-full p-3 pl-12 border border-gray-200 rounded-lg"
                        />
                      </div>
                    </div>
