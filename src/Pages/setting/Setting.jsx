    ...
    const fetchUserData = async () => {
      try {
        ...
        setFormData((prevState) => ({
          ...prevState, // Preserve initial state
          ...response.data.user, // Spread API response directly
          payment_details: {
            ...prevState.payment_details, // Preserve payment details structure
            ...response.data.user?.payment_details, // Merge response
          }
        }));
      ...
      <div className="flex flex-row gap-6">
        <div className="w-1/4 h-1/2 bg-white p-4 rounded-lg shadow-md">
          <ul className="space-y-2">
            ...
            >
              <img src={PersonalIcon} className="w-4 h-4 mr-2 inline" alt="icon" />
              Personal Information
              <img src={DropIcon} className="w-2 h-4 ml-15 inline" alt="dropdown" />
            </li>
            <li
              className={`p-2 rounded-lg cursor-pointer text-gray-600 ${
                activeTab === "password"
            ...
            {activeTab === "storeInfo" ? (
              ...
              <>
                ...
                <div className="">
                  ...
                  />
                  <img
                    src={formData.profileImage ? formData.profileImage : null}
                    alt="Profile"
